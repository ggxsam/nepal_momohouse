      ...
      <div>
        {state.items.length > 0 ? (
          <div className="flex gap-3">
            ...
            <div className=" ml-20 w-80 h-80 flex flex-col    shadow-2xl  shadow-gray-500 rounded-2xl mt-5 gap-y-6 p-10  ">
          ...
          <div>
            <div className="w-96 m-auto mt-40 text-center">
           <img src=" https://cdni.iconscout.com/illustration/premium/thumb/empty-cart-illustration-download-in-svg-png-gif-file-formats--wishlist-bucket-shopping-state-pack-design-development-illustrations-1800917.png" alt="" />
              <h1 className="text-2xl">Cart is Empty</h1>
              <NavLink  className=" underline text-xl text-blue-400 "to="/menu">Shop Now</NavLink>
            </div>
          </div>
        )}
      </div>
